...
**We can solve this problem using [HOCON configuration in Akka.NET](http://getakka.net/articles/concepts/configuration.html#what-is-hocon) without updating any of the code that defines `ChartingActor`.**
...
## Further reading
As you probably guessed while reading the HOCON configs above, any line with `#` at the front of it is treated as a comment in HOCON. [Learn more about HOCON syntax here](http://getakka.net/articles/concepts/configuration.html#what-is-hocon).
